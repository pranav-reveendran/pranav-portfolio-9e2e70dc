...
export function Footer() {
  ...
  return (
    <footer className="py-10 border-t border-[#1e3756] bg-[#05101f] transition-colors duration-500">
      <div className="container mx-auto px-6 md:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mb-4 md:mb-0">
            <a href="mailto:pranav.reveendran@sjsu.edu" className="text-[#a2adc9] hover:text-[#0077CC] transition-colors">
              <MailIcon className="w-5 h-5" />
            </a>
            <a href="tel:+16603357762" className="text-[#a2adc9] hover:text-[#0077CC] transition-colors">
              <PhoneIcon className="w-5 h-5" />
            </a>
            <a href="https://linkedin.com/in/pranavreveendran" className="text-[#a2adc9] hover:text-[#0077CC] transition-colors">
